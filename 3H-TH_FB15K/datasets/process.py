...
def get_idx(path):
    ...
    for split in ["train", "valid", "test", "composition_test", "inversion_test", "symmetry_test", "multiple_relation_test", "antisymmetry_test"]:
...
def process_dataset(path):
    ...
    examples = {}
    splits = ["train", "valid", "test", "composition_test", "inversion_test", "symmetry_test", "multiple_relation_test", "antisymmetry_test"]
    for split in splits:
...
if __name__ == "__main__":
    ...
    for dataset_name in os.listdir(data_path):
        ...
        for dataset_split in ["train", "valid", "test", "composition_test", "inversion_test", "symmetry_test", "multiple_relation_test", "antisymmetry_test"]:
