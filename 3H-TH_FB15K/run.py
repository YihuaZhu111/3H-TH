...
def train(args):
    ...
    composition_test_examples = dataset.get_examples("composition_test")
    inversion_test_examples = dataset.get_examples("inversion_test")
    symmetry_test_examples = dataset.get_examples("symmetry_test")
    multiple_relation_test_examples = dataset.get_examples("multiple_relation_test")
    antisymmetry_test_examples = dataset.get_examples("antisymmetry_test")
    ...
    composition_test_metrics = avg_both(*model.compute_metrics(composition_test_examples, filters))
    logging.info(format_metrics(composition_test_metrics, split="composition_test"))

    inversion_test_metrics = avg_both(*model.compute_metrics(inversion_test_examples, filters))
    logging.info(format_metrics(inversion_test_metrics, split="inversion_test"))

    symmetry_test_metrics = avg_both(*model.compute_metrics(symmetry_test_examples, filters))
    logging.info(format_metrics(symmetry_test_metrics, split="symmetry_test"))

    multiple_relation_test_metrics = avg_both(*model.compute_metrics(multiple_relation_test_examples, filters))
    logging.info(format_metrics(multiple_relation_test_metrics, split="multiple_relation_test"))

    antisymmetry_test_metrics = avg_both(*model.compute_metrics(antisymmetry_test_examples, filters))
    logging.info(format_metrics(antisymmetry_test_metrics, split="antisymmetry_test"))
