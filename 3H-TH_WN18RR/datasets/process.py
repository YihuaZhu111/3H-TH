...
def get_idx(path):
    ...
    for split in ["train", "valid", "test", "0_test", "1_test", "2_test", "3_test", "4_test", "5_test", "6_test", "7_test", "8_test", "9_test", "10_test"]:
...
def process_dataset(path):
    ...
    examples = {}
    splits = ["train", "valid", "test", "0_test", "1_test", "2_test", "3_test", "4_test", "5_test", "6_test", "7_test", "8_test", "9_test", "10_test"]
    for split in splits:
...
if __name__ == "__main__":
    ...
    for dataset_name in os.listdir(data_path):
        ...
        for dataset_split in ["train", "valid", "test", "0_test", "1_test", "2_test", "3_test", "4_test", "5_test", "6_test", "7_test", "8_test", "9_test", "10_test"]:
